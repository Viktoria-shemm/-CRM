...
//     "Категория товара"
//   );
//   const productPrice = prompt("Введите цену товара:", "Цена товара");
...

{
  ...
  if (Number.isFinite(productPriceNumber)&&Number.isFinite(productQuantityNumber)) {
    console.log(`На складе ${productQuantityNumber} единицы товара "${productName}" на сумму ${totalAmount} деревянных`);
  } else {
